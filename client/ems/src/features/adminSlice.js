...
export const getallAdmins = createAsyncThunk("admin/getAll", async (_, {rejectWithValue}) => {
  try{
const response = await axios.get(" https://reporting-management-system.onrender.com/api/superadmin/get-alladmins");
...
export const getallactiveAdmins = createAsyncThunk("admin/getAllactive", async (_, {rejectWithValue}) => {
    try{
  const response = await axios.get(" https://reporting-management-system.onrender.com/api/superadmin/get-allActive-admin");
...
export const addnewAdmin= createAsyncThunk('add/Admin', async(adminData, {rejectWithValue})=>{
    try{
    const response= await axios.post(' https://reporting-management-system.onrender.com/api/superadmin/add-admin', adminData);
    console.log(response);
...
export const deleteAdmin= createAsyncThunk('remove/admin', async(username, {rejectWithValue})=>{
  try{
   ...
   const response= await axios.delete(` https://reporting-management-system.onrender.com/api/superadmin/delete-admin/${username}`)
   console.log(response);
