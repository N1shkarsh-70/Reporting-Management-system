...
export const getallAdmins = createAsyncThunk("admin/getAll", async (_, {rejectWithValue}) => {
  try{
const response = await axios.get(" http://localhost:3000/api/superadmin/get-alladmins");
...
export const getallactiveAdmins = createAsyncThunk("admin/getAllactive", async (_, {rejectWithValue}) => {
    try{
  const response = await axios.get(" http://localhost:3000/api/superadmin/get-allActive-admin");
...
export const addnewAdmin= createAsyncThunk('add/Admin', async(adminData, {rejectWithValue})=>{
    try{
    const response= await axios.post(' http://localhost:3000/api/superadmin/add-admin', adminData);
    console.log(response);
...
export const deleteAdmin= createAsyncThunk('remove/admin', async(username, {rejectWithValue})=>{
  try{
   ...
   const response= await axios.delete(` http://localhost:3000/api/superadmin/delete-admin/${username}`)
   console.log(response);
