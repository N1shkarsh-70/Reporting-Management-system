...
export const addIssue = createAsyncThunk("plaza/addIssue", async (payload, { rejectWithValue, getState }) => {
  try {
    ...
    const response = await axios.post(" http://localhost:3000/api/superadmin/add-issue", payload, {
...
export const getAllPendingIssues = createAsyncThunk("plaza/getAllPendingIssues", async (_, { rejectWithValue, getState }) => {
  try {
    const token = getState().auth.token;
    const response = await axios.get(" http://localhost:3000/api/superadmin/get-allPendingIssues", {
      headers: { Authorization: `Bearer ${token}` },
    });
...
export const getIssuesByPlazaId = createAsyncThunk("plaza/getIssuesByPlazaId", async (_, { rejectWithValue, getState }) => {
  try {
    const token = getState().auth.token;
    const response = await axios.get(" http://localhost:3000/api/superadmin/get-issuesByPlazaId", {
      headers: { Authorization: `Bearer ${token}` },
    });
    console.log("API Response:", response.data);
    return response.data.issues;
...
export const getAllIssues = createAsyncThunk("plaza/getAllIssues", async (_, { rejectWithValue, getState }) => {
  try {
    const token = getState().auth.token;
    const response = await axios.get(" http://localhost:3000/api/superadmin/get-allIssues", {
      headers: { Authorization: `Bearer ${token}` },
    });
    console.log("API Response:", response.data);
    return response.data.issues;
...
export const resolveIssue = createAsyncThunk(
  ...
  async ({ issueId, remarks }, { rejectWithValue, getState }) => {
    try {
      const token = getState().auth.token;
      const response = await axios.post(" http://localhost:3000/api/superadmin/resolve-issue", {
        issueId,
        remarks,
      }, {
        headers: { Authorization: `Bearer ${token}` },
...
export const getPendingIssuesById = createAsyncThunk(
  ...
  async (_, { rejectWithValue, getState }) => {
    ...
    try {
      const token = getState().auth.token;
      const response = await axios.get(" http://localhost:3000/api/superadmin/get-allPendingIssuesById", {
        headers: { Authorization: `Bearer ${token}` },
      });
      console.log(response);
...
export const getIssuesByProjectId = createAsyncThunk("issues/getIssuesByProjectId",
  async (projectId, { rejectWithValue, getState }) => {
    ...
    try {
      const token = getState().auth.token;
      const response = await axios.get(` http://localhost:3000/api/superadmin/get-projectIssues/${projectId}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
      console.log(response);
...
export const updateIssue = createAsyncThunk("issues/getIssuesByProjectId",
  async (payload, { rejectWithValue, getState }) => {
    ...
    try {
      const token = getState().auth.token;
      const response = await axios.put(` http://localhost:3000/api/superadmin/updateIssue,payload`, {
        headers: {
