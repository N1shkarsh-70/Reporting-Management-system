        ...
        <form onSubmit={handleSubmit}>
          ...
          <div>
            <div className="text-center mt-4">
              <p className="text-sm text-gray-600">Use below credential to login as admin </p>
            </div>
              <h4>Email:<label className="text-blue-600">nishkarsh12@gmail.com</label></h4>
              <h4>Password:<label className="text-blue-600"> nishkarsh@123</label></h4>
            </div>
        </form>
      </div>
